...
async function create(req, res) {
  try {
    ...
    // send sms
    const message = `Hello ${firstname} ${lastname}, , welcome to the ${organisation.name} family!  We're thrilled to have you join us and excited to help you find the perfect eyewear to enhance your vision and style. For further information please call 0544257189, 0243424984 or 0245032935.`;
